...
export default function ServiceUpload () {
    return <Page PreviewComponent={ServicePage} pinPrepend={'services/'} title={'Upload Services'} subTitle={'Create new service page'} initialValue={{tg: 'service_tag', textLocation: 'middle', backgroundPosition: '50'}} tags={[{key: 'tg', disabled: true, type: 'text', placeholder: 'Default Tag'}, {key: 'title', type: 'text', placeholder: 'Enter Service Name'}, {key: 'description', type: 'text', placeholder: 'Enter Description'},  {key: 'textLocation', type: 'radio', options: [
