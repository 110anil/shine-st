...
const AlbumRenderer = ({title, images, height = 105, width = 210, logoMap, onClose}) => {
    ...
    return (
        <Modal>
            <div className={cs(styles.container, onClose && styles.close)} style={{
                '--bg': `url('${logoMap.whiteLogo}')`
            }}>
                {onClose && <label onClick={onClose}>Close</label>}
